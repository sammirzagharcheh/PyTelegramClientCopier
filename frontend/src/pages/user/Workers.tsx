...
export function UserWorkers() {
  ...
  return (
    <div>
      ...
      {isError ? (
        <ErrorState title="We couldn't load your workers" error={error} onRetry={() => refetch()} />
      ) : (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          {isLoading ? (
            ...
            <>
              ...
              <Card flush>
                <CardHeader title="Start a worker" icon={Zap} inset />
                      ...
                      return (
                        ...
                        >
                          ...
                          <Button
                            ...
                            disabled={running}
                            isLoading={startMutation.isPending && startMutation.variables === a.id}
                          >
