...
| Account dialogs / bot manual chat IDs | `src/app/telegram/dialog_service.py`, `src/app/telegram/bot_token.py`, `src/app/web/routers/accounts.py`, `frontend/src/components/MappingRouteFields.tsx` | `pytest tests/unit/test_dialog_service.py tests/unit/test_bot_token.py tests/api/test_account_dialogs_api.py`, `cd frontend && npm run test -- src/components/MappingRouteFields.test.tsx` |
