...
| Dashboard setup checklist / copied-only message counts | `src/app/web/routers/stats.py`, `frontend/src/pages/user/Dashboard.tsx` | `pytest tests/api/test_stats_api.py`, `cd frontend && npm run test -- src/pages/user/Dashboard.test.tsx` |
