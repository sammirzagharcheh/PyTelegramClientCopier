...
| Change reply mapping/index behavior | `src/app/telegram/handlers.py`, `src/app/db/gateway.py`, `alembic/versions/*` | `pytest tests/functional/test_handler_flow.py tests/integration/test_reply_mapping.py` |
...
| DB schema/migration change | `src/app/db/models.py`, `src/app/db/gateway.py`, `alembic/versions/*`, affected routers/services | `pytest tests/unit/test_migrations.py` plus feature-specific tests |
