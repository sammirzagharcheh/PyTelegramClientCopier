...
| Native VPS | [deploy-ubuntu.md](deploy-ubuntu.md) | venv + systemd + nginx; `update-vps.sh` auto-backs up under `backups/`; `prune-vps-backups.sh` + `backup.conf` (default keep 10) |
